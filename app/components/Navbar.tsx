    ...
    >
      ...
      <div className="">
        <Link href="/" className="text-sm">
          <p className="text-[18px] font-bold cursor-pointer flex dark:text-[#DEDEDE]">
            Tejas Saindane
          </p>
        </Link>
      </div>
      <div className="hidden md:flex gap-4 text-black dark:text-[#DEDEDE] font-semibold">
        {links.map((link) => (
